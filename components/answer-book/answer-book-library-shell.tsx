...
import { SubjectCard, type AnswerBookSubjectData } from "@/components/answer-book/subject-card";

export interface AnswerBookLibrarySubject extends AnswerBookSubjectData {
  topicTitles: string[];
}

export function AnswerBookLibraryShell({ subjects }: { subjects: AnswerBookLibrarySubject[] }) {
      ...
      <header className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-secondary text-sm">
            Your AI-generated study materials, organized by subject.
          </p>
        </div>
        ...
        <div className="border-border bg-surface flex flex-col items-center gap-3 rounded-2xl border py-16 text-center">
          ...
          <div>
            ...
            <p className="text-text-secondary mt-1 text-sm">
              Add a subject and generate study notes from a topic to build your Answer Book.
            </p>
          </div>
          <Link
